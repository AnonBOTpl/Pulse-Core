...
*   **Silnik Audio:** `BASS` (przez `bass-rs`) - Wybrany ze względu na lepszą wydajność, sprzętowe buforowanie i stabilne przewijanie.
...
*   Wykorzystuj `StreamChannel` z `bass-rs` do zarządzania odtwarzaniem.
